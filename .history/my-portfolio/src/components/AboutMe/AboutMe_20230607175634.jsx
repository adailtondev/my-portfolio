    ...
    <section className="about-me min-vh-100">
      ...
      <div className="about-txt">
        ...
        <div className="about-tech">
          <div className="techs">
            <span><Icon icon="logos:html-5" /></span>
          </div>
          <div className="techs">
            <span><Icon icon="logos:css-3" /></span>
          </div>
          <div className="techs">
            <span><Icon icon="logos:javascript" /></span>
          </div>
          <div className="techs">
            <span><Icon icon="devicon:react" /></span>
          </div>
          <div className="techs">
          <span><Icon icon="vscode-icons:file-type-node" /></span>
          </div>
          <div className="techs">
            <span><Icon icon="devicon:typescript" /></span>
          </div>
          <div className="techs">
            <span><Icon icon="skill-icons:bootstrap" /></span>
          </div>
          <div className="techs">
            <span><Icon icon="devicon:tailwindcss" /></span>
          </div>
        </div>
      </div>
    </section>
