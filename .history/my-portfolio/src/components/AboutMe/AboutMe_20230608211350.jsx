...
export default function AboutMe() {
  ...
  return (
    <section id="meuElemento" className="about-me min-vh-100">
      ...
      <div className="about-txt">
        ...
        <p>
          ...
          considerar uma <span style={{fontWeight: '700', textDecoration: 'underline'}}>carreira na área de tecnologia.</span>
        </p>
        <p>
          ...
          <span style={{fontWeight: '700 '}}> React e TypeScript</span>, enquanto também revisito conceitos mais básicos
          para solidificar meu conhecimento.
        </p>
        <p>
          Embora esteja focado em React, <span style={{fontWeight: '700', textDecoration: 'underline'}}>estou totalmente aberto a aprender
          novas tecnologias.</span> Estou ansioso para expandir meu conjunto de
