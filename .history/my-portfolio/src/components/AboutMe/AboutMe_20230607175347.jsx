    ...
    <section className="about-me min-vh-100">
      ...
      <div className="about-txt">
        ...
        <div className="about-tech">
            <div className="techs"><Icon icon="logos:html-5" /></div>
            <div className="techs"><Icon icon="logos:css-3" /></div>
            <div className="techs"><Icon icon="logos:javascript" /></div>
            <div className="techs"><Icon icon="devicon:react" /></div>
            <div className="techs"><Icon icon="logos:javascript" /></div>
            <div className="techs"><Icon icon="devicon:typescript" /></div>
            <div className="techs"><Icon icon="skill-icons:bootstrap" /></div>
            <div className="techs"><Icon icon="devicon:tailwindcss" /></div>
        </div>
      </div>
    </section>
  );
